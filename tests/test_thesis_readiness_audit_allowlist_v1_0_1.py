"""Structural, synthetic/config-only checks for readiness-audit allowlist v1.0.1."""
...
ALLOWLIST_PATH = ROOT / "configs/thesis_readiness_audit_v1_0_1_allowlist.yaml"
...
class ThesisReadinessAuditAllowlistTests(unittest.TestCase):
    ...
    def test_preparation_does_not_self_authorize_review_or_audit(self) -> None:
        ...
        self.assertEqual(self.control["version"], "1.0.1")
        self.assertEqual(
    ...
    def test_successor_pins_failed_review_and_preserves_v1_0_0(self) -> None:
        ...
        self.assertEqual(predecessor["version"], "1.0.0")
    ...
    def test_safe_verifiers_are_exact_non_writing_and_context_limited(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                ...
                "-m",
                "unittest",
                "tests/test_thesis_readiness_audit_allowlist_v1_0_1.py",
            ],
        )
        self.assertEqual(
    ...
    def test_audit_writes_only_new_exact_outputs(self) -> None:
        ...
        self.assertEqual(
            outputs,
            [
                "configs/thesis_readiness_audit_v1_0_1_result.yaml",
                "docs/14_thesis_readiness_audit_v1_0_1.md",
                "tests/test_thesis_readiness_audit_boundary_v1_0_1.py",
            ],
        )
        ...
        self.assertEqual(
            incident_outputs,
            [
                "configs/thesis_readiness_audit_access_incident_v1_0_1.yaml",
                "docs/13_1_thesis_readiness_audit_access_incident_v1_0_1.md",
            ],
        )
