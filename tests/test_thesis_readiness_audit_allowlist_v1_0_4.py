"""Structural, synthetic/config-only checks for readiness-audit allowlist v1.0.4."""
...
ALLOWLIST_PATH = ROOT / "configs/thesis_readiness_audit_v1_0_4_allowlist.yaml"
...
class ThesisReadinessAuditAllowlistTests(unittest.TestCase):
    ...
    def test_preparation_does_not_self_authorize_review_or_audit(self) -> None:
        ...
        self.assertEqual(self.control["version"], "1.0.4")
        self.assertEqual(
    ...
    def test_successor_pins_failed_review_and_preserves_ancestors(self) -> None:
        ...
        self.assertEqual(predecessor["version"], "1.0.3")
        self.assertEqual(
            predecessor["git_commit"],
            "2a08d0935e7bb49c33b1df0a0da9470d6d0748ae",
        )
        ...
        self.assertEqual(
            review["git_commit"],
            "b5ff66e2b937e85813e955f5d64954a99f4252ed",
        )
    ...
    def test_review_scope_is_narrow_non_analytical_and_existing(self) -> None:
        ...
        self.assertIn(
            "tests/test_thesis_readiness_audit_allowlist_v1_0_4.py",
            review,
        )
        executor_paths = {
            path
    ...
    def test_safe_verifiers_are_exact_non_writing_and_context_limited(self) -> None:
        ...
        self.assertEqual(
            set(by_id),
            {
                ...
                "thesis_readiness_audit_boundary_v1_0_4",
        ...
        audit_boundary = by_id["thesis_readiness_audit_boundary_v1_0_4"]
        self.assertEqual(
    ...
    def test_review_subject_uses_simple_1000_line_guidance_under_2000_cap(self) -> None:
        ...
        subject = "configs/thesis_readiness_audit_v1_0_4_allowlist.yaml"
    ...
    def test_review_commit_is_exactly_limited_to_three_outputs(self) -> None:
        ...
        self.assertEqual(
            review_outputs,
            [
                "configs/thesis_readiness_audit_allowlist_review_v1_0_4.yaml",
                "docs/13_thesis_readiness_audit_allowlist_review_v1_0_4.md",
        ...
        for context, mapping in triggers.items():
            ...
            for route_id in mapping.values():
                ...
                if route_id in {
                    ...
                    self.assertFalse(route["new_allowlist_version_required"])
                    if route_id == "retryable_audit_output_nonconformance":
    ...
    def test_audit_writes_only_new_exact_outputs(self) -> None:
        ...
        self.assertEqual(
            incident_outputs,
            [
                "configs/thesis_readiness_audit_access_incident_v1_0_4.yaml",
                "docs/13_1_thesis_readiness_audit_access_incident_v1_0_4.md",
            ],
        )
